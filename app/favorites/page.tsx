...
import { readStoredJson, removeStoredValue } from "../lib/storage";
...
export default function FavoritesPage() {
  ...
  useEffect(() => {
    ...
    const codes = readStoredJson<string[]>("icpc-trainer-favorites", [], (value): value is string[] => Array.isArray(value) && value.length <= 500 && value.every((item) => typeof item === "string"));
