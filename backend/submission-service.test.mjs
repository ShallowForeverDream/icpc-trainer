  ...
  try {
    ...
    const create = await fetch(`${baseUrl}/platform-submissions`, {
      ...
      body: JSON.stringify({
        ...
        requestId,
        judge: "ucup",
        problemCode: "2025-shenyang-A",
        problemTitle: "Square Kingdom",
        problemHref: "/vp/archive/problem?contest=2025-shenyang&slot=A",
        contestId: 2641,
        problemIndex: "A",
        language: "GNU C++20",
        sourceCode: "#include <bits/stdc++.h>\nusing namespace std;\nint main(){ return 0; }",
        status: "queued",
        message: "正在连接 Universal Cup / QOJ",
        archiveContestId: "2025-shenyang",
        slot: "A",
      }),
    });
