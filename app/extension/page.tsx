...
export default function ExtensionPage() {
  return <AppShell active="提交扩展">
    <section className="extension-hero">
      <div><span className="eyebrow"><span className="live-dot" /> CHROME / EDGE · MANIFEST V3</span><h1>留在平台，<br /><em>直接完成提交。</em></h1><p>支持 Codeforces、Codeforces Gym 与 Universal Cup / QOJ。点击站内“直接提交”后，扩展使用你浏览器已有的登录会话在后台完成提交，并可同时跟踪多条判题任务。</p><div className="hero-actions"><a className="button button-primary" href="/icpc-trainer-extension.zip" download><Icon name="spark" /> 下载扩展包 v1.2</a></div></div>
